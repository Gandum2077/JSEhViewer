...
const TAGTRANSLATOR_DICT = JSON.parse($file.read(glv.tagTranslationFile).string);
...
// 获取用户名密码，可用于async/await
async function getUsernamePassword(title) {
...
// 冻结屏幕，并播放动画，表示等待状态
// 这是一个ugly的方法，它要求整个应用中不能再有同id的view（即loadingView_e582da14）
