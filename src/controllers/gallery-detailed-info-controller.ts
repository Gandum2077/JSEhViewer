...
function _mapData(
  ...
  data.push({
    title: { text: "GID" },
    content: { text: infos.gid.toString() },
  });
  ...
  data.push({
    title: { text: "标题（英）" },
    content: { text: infos.english_title },
  });
  if (infos.japanese_title) {
    data.push({
      title: { text: "标题（日）" },
      content: { text: infos.japanese_title },
    });
  }
  data.push({
    title: { text: "缩略图" },
    content: { text: infos.thumbnail_url },
  });
  data.push({ title: { text: "类别" }, content: { text: infos.category } });
  data.push({
    title: { text: "上传者" },
    content: { text: infos.uploader || "(已放弃)" },
  });
  data.push({
    title: { text: "发布时间" },
    content: { text: toSimpleUTCTimeString(infos.posted_time) },
  });
  ...
  data.push({
    title: { text: "页数" },
    content: { text: infos.length.toString() },
  });
  data.push({
    title: { text: "平均分" },
    content: { text: infos.average_rating.toString() },
  });
  data.push({
    title: { text: "评分次数" },
    content: { text: infos.rating_count.toString() },
  });
  data.push({
    title: { text: "收藏次数" },
    content: { text: infos.favorite_count.toString() },
  });
  return data;
}
